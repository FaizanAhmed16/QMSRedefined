...
const CreateQuiz = () => {
    ...
    const addQuestion = async (e) => {
        ...
        if (correctOption == undefined) {
            ...
            axios.post("http://localhost:3000/examquestions/", newQuestion).then((response) => {
    ...
    const handleOptions = ({ data, inputOption }) => {
        ...
        for (let i = 0; i < inputOption.length; i++) {
            ...
            console.log(option);
            axios.put("http://localhost:3000/examquestions/" + data, option).then((response) => {
                console.log(response.status);
    ...
    const deleteQuestion = (propId) => {
        axios.delete('http://localhost:3000/examquestions/' + propId).then((response) => {
            console.log(response.status);
